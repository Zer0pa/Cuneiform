# Roadmap: gnosis-cuneiform

## Phases

- [x] **Phase 00: Truth-Surface Bootstrap** - Replace generic starter state
      with the actual control-pack posture.
- [x] **Phase 01: Control Boundary And Rerun Ledger** - Freeze the first
...
- any wording upgrades `NO_GO_GOVERNING_GATE_UNMET` into a pass,
- source extraction requires generic helper ownership from another workstream,
- the first rerun target needs restricted pixels without a fetch/checksum plan.
