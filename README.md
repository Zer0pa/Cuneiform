...
<div><b>05.3 · BENCHMARKS</b> <span>PHASE-2 RESULT STATUS</span></div>
      <div>
        ...
        <div>
          <div><span>P5</span>  <span>0.021916 &middot; NO-GO</span></div>
          <div><span>P6 diagnostic</span>  <span>0.038176</span></div>
          <div><span>Manifest</span>  <span>5/5 PASS</span></div>
        </div>
      </div>
...
<div><b>06.1 · RESULT LEDGER · PHASE-2 STATUS</b></div>
      <div>
        <div>
          <div><span>P5 · governing 1NN</span>  <span>0.021916 · NO-GO</span></div>
          <div><span>P6 · diagnostic</span>  <span>0.038176</span></div>
          <div><span>P7</span>  <span>0.051826</span></div>
          <div><span>Manifest</span>  <span>5/5 PASS</span></div>
        </div>
      </div>
