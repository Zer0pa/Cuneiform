...
| `04_evidence_manifest/README.md` | Registers Phase 01 artefacts with their custody class. | Updated |
| Git remote | `https://github.com/Zer0pa/Cuneiform` (INTERNAL, `main`) wired from current workstream root. | Live |
| `05_repo_scaffold/UNIVERSAL_STARTUP_PROMPT.md` | Path drift (old `/Users/Zer0pa/ZPE/...`) repaired. | Updated |
